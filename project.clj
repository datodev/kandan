(defproject kandan "0.1.0-SNAPSHOT"
  ...
  :plugins [[cider/cider-nrepl "0.9.1"]
            [lein-cljsbuild "1.0.6" :exclusions [org.clojure/clojurescript]]
            [lein-environ "1.0.0"]
            [lein-less "1.7.5"]
            [lein-figwheel "0.3.9"]
