...
(def react-date-format
  (goog.i18n.DateTimeFormat. "yyy-MM-dd"))
...
(def short-consistent-date-format
  (goog.i18n.DateTimeFormat. "MMM dd"))

(def short-consistent-date
  (partial format-date short-consistent-date-format))
